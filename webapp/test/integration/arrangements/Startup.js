sap.ui.define([
	"sap/ui/test/Opa5",
	"newellco/fiori/project/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("newellco.fiori.projectedit.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "newellco.fiori.projectedit",
					async: true
				},
				hash: oOptions.hash,
